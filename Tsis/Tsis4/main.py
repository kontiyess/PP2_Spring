...
def run_game(settings: dict, player_id: Optional[int], personal_best: int) -> tuple[int, int]:
    """
    ...
    pygame.mixer.music.load("Tsis/Tsis4/assets/music/bg.mp3")
    ...
    # Power-up state
    active_pu         : Optional[str] = None   # name of active effect
